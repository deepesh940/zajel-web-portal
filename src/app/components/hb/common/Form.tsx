...
export function FormModal({
  ...
  return (
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/50">
      <div className={cn(
        "bg-white dark:bg-neutral-950 border border-neutral-200 dark:border-neutral-800 rounded-lg shadow-xl w-full flex flex-col max-h-[90vh]", 
        maxWidth
      )}>
        {/* Header */}
  ...
  ({ className, children, ...props }, ref) => {
    return (
      <SelectItem 
        ref={ref}
        className={cn(
          "rounded-md py-2.5 pl-4 pr-8 cursor-pointer focus:bg-primary-50 dark:focus:bg-primary-950/50 focus:text-primary-900 dark:focus:text-primary-100 text-neutral-700 dark:text-neutral-300 first:rounded-t-md last:rounded-b-md", 
          className
        )} 
        {...props}
      >
